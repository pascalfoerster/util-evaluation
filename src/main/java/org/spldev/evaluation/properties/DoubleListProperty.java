...
public class DoubleListProperty extends AProperty<List<Double>> {

	public DoubleListProperty(String name) {
		super(name, Collections.emptyList());
	}

	public DoubleListProperty(String name, Double defaultValue) {
		super(name, Arrays.asList(defaultValue));
	}

	@Override
	protected List<Double> cast(String valueString) throws Exception {
